/**
 * Position Controller standalone application.
 *
...
int main(int argc, char ** argv)
{
  ROS2AppManager<rclcpp::executors::MultiThreadedExecutor,
    position_controller::PositionControllerNode> app_manager(
    argc,
    argv,
    "position_controller_app");

  SignalHandler & sig_handler = SignalHandler::get_global_signal_handler();
  sig_handler.init(
    app_manager.get_context(),
    "position_controller_app_signal_handler",
